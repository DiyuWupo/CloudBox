...
-- ====================================================
-- AUTO-UPDATE
-- Every launch, this checks GitHub for a newer version of
...
local function selfUpdate()
    ...
    -- Bail out if GitHub gave us something that isn't actually our
    -- script (e.g. a 404 page instead of raw code).
    -- Real code always contains this marker line; a bad response won't.
